...
# Declaration Convention (good practices)
#1 Lower Case 
Name = "nitin"  #❌
name = "nitin"  #✅

#2 (a)Use Undercasing (Snake Casing)
fullname ="nitin mehta"     #❌
full__name = "nitin mehta"  #✅

# (b)Camel Casing 
Ec2InstanceName = ""   #❌
ec2InstanceName = ""   #✅

#3 keep variable as descriptive as possible     
f_n        = "nitin mehta"   #❌
full__name = "nitin mehta"   #✅
